...
class AssetController extends Controller implements \Illuminate\Routing\Controllers\HasMiddleware
{
    ...
    public function index(Request $request)
    {
        ...
        $healthService = app(\App\Services\PredictiveHealthService::class);
        $assets->transform(function ($asset) use ($healthService) {
            $asset->health_data = $healthService->calculateAssetHealth($asset);
            return $asset;
        });
