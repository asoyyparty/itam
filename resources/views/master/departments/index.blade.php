        ...
        <form action="{{ route('departments.index') }}" method="GET">
            <div class="position-relative w-100" style="max-width: 400px;">
                ...
                <div class="position-absolute d-flex align-items-center" style="top: 50%; right: 5px; transform: translateY(-50%); gap: 4px;">
                    @if(request('search'))
                        <a href="{{ route('departments.index') }}" class="text-muted" style="display: flex; align-items: center; justify-content: center; width: 26px; height: 26px; border-radius: 50%; text-decoration: none;"><i class="fas fa-times"></i></a>
                    @endif
