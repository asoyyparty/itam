...
<div class="row mb-3 align-items-center">
        ...
        <form action="{{ route('locations.index') }}" method="GET">
            <div class="position-relative w-100" style="max-width: 400px;">
                ...
                <div class="position-absolute d-flex align-items-center" style="top: 50%; right: 5px; transform: translateY(-50%); gap: 4px;">
                    @if(request('search'))
                        <a href="{{ route('locations.index') }}" class="text-muted" style="display: flex; align-items: center; justify-content: center; width: 26px; height: 26px; border-radius: 50%; text-decoration: none;"><i class="fas fa-times"></i></a>
                    @endif
    ...
    <div class="col-12 col-md-6">
        <div class="d-flex flex-nowrap justify-content-md-end align-items-center" style="gap: 8px; overflow-x: auto; padding-bottom: 2px;">
            ...
            <a href="{{ route('locations.export', request()->query()) }}" class="btn btn-sm btn-success text-nowrap flex-shrink-0" style="box-shadow: 0 0 10px rgba(40,167,69,0.3);">
