...
<div class="card theme-card">
    <div class="card-header border-0 d-flex justify-content-between align-items-center flex-wrap" style="gap: 15px;">
        ...
        <div class="card-tools d-flex" style="gap: 10px;">
            <a href="{{ route('brands.export') }}" class="btn btn-sm btn-success"><i class="fas fa-file-excel"></i> <span class="d-none d-sm-inline">{{ __('messages.export') }}</span></a>
            ...
            <a href="{{ route('brands.create') }}" class="btn btn-sm btn-primary"><i class="fas fa-plus"></i> <span class="d-none d-sm-inline">{{ __('messages.add_new') }}</span></a>
        </div>
    </div>
