                            ...
                            <tr>
                                ...
                                <td class="theme-text">
                                    <div class="d-flex align-items-center" style="gap: 6px;">
                                        <code>{{ Str::limit($lic->license_key, 30) ?? '-' }}</code>
                                        @if($lic->license_key)
                                            <button type="button" class="btn btn-xs btn-outline-success copy-license-btn" style="padding: 1px 5px; line-height: 1;" title="{{ __('messages.copy_license') ?? 'Copy License Key' }}" data-license-key="{{ $lic->license_key }}">
